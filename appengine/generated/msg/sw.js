...
BlocklyGamesMsg["Games.puzzle"] = "Fumbo";
BlocklyGamesMsg["Games.maze"] = "Mzingile";
...
BlocklyGamesMsg["Games.linkTooltip"] = "Hifadhi na kiungo cha vishiku.";
BlocklyGamesMsg["Games.runTooltip"] = "Run the program you wrote.";  // untranslated
BlocklyGamesMsg["Games.runProgram"] = "Endesha Programu";
BlocklyGamesMsg["Games.resetTooltip"] = "Stop the program and reset the level.";  // untranslated
BlocklyGamesMsg["Games.resetProgram"] = "Seti upya";
BlocklyGamesMsg["Games.help"] = "Huduma";
...
BlocklyGamesMsg["Games.httpRequestError"] = "Kuna shida na amri.";
BlocklyGamesMsg["Games.linkAlert"] = "Sambaza vishiku vyako na kiungo hiki: \n\n%1";
BlocklyGamesMsg["Games.hashError"] = "Samahani, '%1' haiendani na faili yoyote ya Blockly.";
BlocklyGamesMsg["Games.xmlError"] = "Upakiaji wa faili yako iliyohifadhiwa haiwezekani.  Labda iliundwa na toleo tofauti ya Blockly?";
...
BlocklyGamesMsg["Puzzle.legsChoose"] = "chagua...";
BlocklyGamesMsg["Puzzle.traits"] = "traits:";  // untranslated
BlocklyGamesMsg["Puzzle.error0"] = "Hongera!\nVishiku vyote %1 ni sahihi.";
BlocklyGamesMsg["Puzzle.error1"] = "Uko karibu! Kishiku kimoja ni kosefu.";
BlocklyGamesMsg["Puzzle.error2"] = "Vishiku vi%1 ni kosefu.";
BlocklyGamesMsg["Puzzle.tryAgain"] = "Kishiku kinachobainishwa ni kosefu.";
BlocklyGamesMsg["Puzzle.checkAnswers"] = "Kuangalia Majibu";
BlocklyGamesMsg["Puzzle.helpText"] = "Kwa kila nchi (kijani), ambatisha bendera yake, kuchagua lugha yake, na kupanganya miji yake.";
BlocklyGamesMsg["Maze.moveForward"] = "songa mbele";
BlocklyGamesMsg["Maze.turnLeft"] = "geuka kushoto";
BlocklyGamesMsg["Maze.turnRight"] = "geuka kulia";
BlocklyGamesMsg["Maze.doCode"] = "fanya";
BlocklyGamesMsg["Maze.elseCode"] = "vingenevyo";
BlocklyGamesMsg["Maze.helpIfElse"] = "Hifadhi na kiungo cha vishiku.";
BlocklyGamesMsg["Maze.pathAhead"] = "kama kuna njia mbele";
BlocklyGamesMsg["Maze.pathLeft"] = "kama kuna njia kusoto";
BlocklyGamesMsg["Maze.pathRight"] = "kama kuna njia kulia";
BlocklyGamesMsg["Maze.repeatUntil"] = "rudia mpaka";
BlocklyGamesMsg["Maze.moveForwardTooltip"] = "Kusogeza Bw. Banzi mbele nafasi moja.";
BlocklyGamesMsg["Maze.turnTooltip"] = "Kugeuza Bw. Banzi kushoto au kulia kwa digrii 90.";
BlocklyGamesMsg["Maze.ifTooltip"] = "Iwapo mwelekeo uliobainishwa una njia, kisha fanya matendo fulani.";
BlocklyGamesMsg["Maze.ifelseTooltip"] = "Iwapo mwelekeo uliobainishwa una njia, kisha fanya seti ya kwanza ya matendo. Vingenevyo, fanya seti ya pili ya matendo.";
BlocklyGamesMsg["Maze.whileTooltip"] = "Rudia matendo yalioambatanishwa mpaka mwisho.";
BlocklyGamesMsg["Maze.capacity0"] = "Unavyo bado vishiku vi%0.";
BlocklyGamesMsg["Maze.capacity1"] = "Unacho bado kishiku kimoja.";
BlocklyGamesMsg["Maze.capacity2"] = "Unavyo bado vishiku vi%1.";
...
BlocklyGamesMsg["Maze.helpStack"] = "Panganya vishiku vichache vya 'songa mbele' ili kunisaidia kufikia lengo.";
BlocklyGamesMsg["Maze.helpOneTopBlock"] = "Katika sehemu hii, itabidi upanganye vishiku vyote ndani ya eneo ya kazi nyeupe.";
...
BlocklyGamesMsg["Maze.helpRepeat"] = "Kompyuta ina kumbukumbu ndogo. Fikia mwisho wa njia hii kwa kutumia vishiku viwili tu. Tumia 'rudia' kusudi vishiku viende zaidi ya mara moja.";
...
BlocklyGamesMsg["Maze.helpRepeatMany"] = "Fikia lengo kwa kutumia vishiku vitano tu.";
BlocklyGamesMsg["Maze.helpSkins"] = "Choose your favourite player from this menu.";  // untranslated
BlocklyGamesMsg["Maze.helpIf"] = "Vishiku vya 'iwapo' vitatenda kama masharti yake ni kweli tu. Jaribu kugeuka kushota kama kuna njia kwenda kushoto.";
BlocklyGamesMsg["Maze.helpMenu"] = "Click on %1 in the 'if' block to change its condition.";  // untranslated
BlocklyGamesMsg["Maze.helpWallFollow"] = "Je, unaweza kutatua mzingile mgumu huu? Jaribu kufuatia ukuta wa kushoto. Wanaprogramu wa juu tu!";
...
BlocklyGamesMsg["Movie.radius"] = "rediasi";
BlocklyGamesMsg["Movie.width"] = "upana";
BlocklyGamesMsg["Movie.height"] = "urefu";
