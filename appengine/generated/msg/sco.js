...
BlocklyMsg["PROCEDURES_MUTATORCONTAINER_TOOLTIP"] = "Eik, remuiv, or reorder inputs tae this function.";
BlocklyMsg["PROCEDURES_MUTATORARG_TITLE"] = "input name:";  // untranslated
BlocklyMsg["PROCEDURES_MUTATORARG_TOOLTIP"] = "Eik aen input tae the function.";
...
BlocklyGamesMsg["Games.puzzle"] = "Jigsaw puzzle";
...
BlocklyGamesMsg["Games.linkTooltip"] = "Hain n airt til blocks.";
BlocklyGamesMsg["Games.runTooltip"] = "Run the program you wrote.";  // untranslated
BlocklyGamesMsg["Games.runProgram"] = "Rin Program";
...
BlocklyGamesMsg["Games.help"] = "Heelp";
BlocklyGamesMsg["Games.catLogic"] = "Logeec";
BlocklyGamesMsg["Games.catLoops"] = "Luips";
BlocklyGamesMsg["Games.catMath"] = "Maths";
BlocklyGamesMsg["Games.catText"] = "Tex";
BlocklyGamesMsg["Games.catLists"] = "Leets";
...
BlocklyGamesMsg["Games.httpRequestError"] = "Thaur wis ae problem wi the request.";
BlocklyGamesMsg["Games.linkAlert"] = "Shair yer blocks wi this airtin:\n\n%1";
BlocklyGamesMsg["Games.hashError"] = "Sairrie, '%1' disna correspond wi onie hained program.";
BlocklyGamesMsg["Games.xmlError"] = "Coudnae laid yer hained file.  Perhaps it wis makit wi ae deefferent version o Blockly?";
...
BlocklyGamesMsg["Games.listVariable"] = "leet";
BlocklyGamesMsg["Games.textVariable"] = "tex";
...
BlocklyGamesMsg["Puzzle.legsChoose"] = "chuise...";
BlocklyGamesMsg["Puzzle.traits"] = "traits:";  // untranslated
BlocklyGamesMsg["Puzzle.error0"] = "Perfect!\nAw %1 blocks ar correct.";
BlocklyGamesMsg["Puzzle.error1"] = "Naerlie! yin block is oncorrect.";
BlocklyGamesMsg["Puzzle.error2"] = "%1 blocks ar oncorrect.";
BlocklyGamesMsg["Puzzle.tryAgain"] = "The heilichted block is no correct.\nKeep it up.";
BlocklyGamesMsg["Puzzle.checkAnswers"] = "Check Answers";
BlocklyGamesMsg["Puzzle.helpText"] = "Fer ilka kintrie (green), attach its banner, chuise its leid, an mak ae stack o its cities.";
BlocklyGamesMsg["Maze.moveForward"] = "muiv forewaird";
BlocklyGamesMsg["Maze.turnLeft"] = "turn cair";
BlocklyGamesMsg["Maze.turnRight"] = "turn richt";
BlocklyGamesMsg["Maze.doCode"] = "dae";
BlocklyGamesMsg["Maze.elseCode"] = "itherwise";
BlocklyGamesMsg["Maze.helpIfElse"] = "Gif-itherwise blocks will dae yin thing or the ither.";
BlocklyGamesMsg["Maze.pathAhead"] = "gif path is aheid";
BlocklyGamesMsg["Maze.pathLeft"] = "gif path is oan the cair";
BlocklyGamesMsg["Maze.pathRight"] = "gif path is oan the richt";
BlocklyGamesMsg["Maze.repeatUntil"] = "repeat ontil";
BlocklyGamesMsg["Maze.moveForwardTooltip"] = "Muivs the player forewaird yin space.";
BlocklyGamesMsg["Maze.turnTooltip"] = "Turns the player cair or richt bi 90 degrees.";
BlocklyGamesMsg["Maze.ifTooltip"] = "Gif thaur is ae path in the speceefied direction, than dae some aictions.";
BlocklyGamesMsg["Maze.ifelseTooltip"] = "Gif thaur is ae path in the speceefied direction, than dae the first block o aictions. Itherwise, dae the seicont block o aictions.";
BlocklyGamesMsg["Maze.whileTooltip"] = "Repeat the enclaised aictions ontil the finish point is reached.";
BlocklyGamesMsg["Maze.capacity0"] = "Ye hae %0 blocks left.";
BlocklyGamesMsg["Maze.capacity1"] = "Ye hae %1 block left.";
BlocklyGamesMsg["Maze.capacity2"] = "Ye hae %2 blocks left.";
BlocklyGamesMsg["Maze.runTooltip"] = "Maks the player dae whit the blocks say.";
BlocklyGamesMsg["Maze.resetTooltip"] = "Put the player back at the stairt o the maze.";
BlocklyGamesMsg["Maze.helpStack"] = "Stack some 'muiv forewaird' blocks thegather tae heelp me reach the goal.";
BlocklyGamesMsg["Maze.helpOneTopBlock"] = "Oan this level, ye need tae stack thegather aw o the blocks in the white warkspace.";
BlocklyGamesMsg["Maze.helpRun"] = "Rin yer program tae see whit happens.";
BlocklyGamesMsg["Maze.helpReset"] = "Yer program didna solve the maze.  Press 'Reset' n gie it anither shot.";
BlocklyGamesMsg["Maze.helpRepeat"] = "Reach the end o this path uisin yinlie twa blocks.  Uise 'repeat' tae rin ae block mair than yince.";
BlocklyGamesMsg["Maze.helpCapacity"] = "Ye'v uised up aw the blocks fer this level.  Tae mak ae new block, ye maun first delyte aen exeestin block.";
BlocklyGamesMsg["Maze.helpRepeatMany"] = "Ye can fit mair than yin block inside ae 'repeat' block.";
BlocklyGamesMsg["Maze.helpSkins"] = "Chuise yer favoorite player fae this menu.";
BlocklyGamesMsg["Maze.helpIf"] = "Ae 'gif' block will dae sommit yinlie gif the condeetion is true.  Gie turnin cair ae shot gif thaur is ae path oan the cair.";
BlocklyGamesMsg["Maze.helpMenu"] = "Clap oan %1 in the 'gif' block tae chynge its condeetion.";
BlocklyGamesMsg["Maze.helpWallFollow"] = "Can ye solve this compleecated maze?  Gie follaein the cair waa ae shot.  Advanced programmers yinlie!";
...
BlocklyGamesMsg["Turtle.moveTooltip"] = "Muives the turtle forewaird or backwaird bi the speceefied amoont.";
BlocklyGamesMsg["Turtle.moveForward"] = "muiv forewaird bi";
BlocklyGamesMsg["Turtle.moveBackward"] = "muiv backwaird bi";
BlocklyGamesMsg["Turtle.turnTooltip"] = "Turns the turtle cai or richt bi the speceefied nummer o degrees.";
BlocklyGamesMsg["Turtle.turnRight"] = "turn richt bi";
BlocklyGamesMsg["Turtle.turnLeft"] = "turn cair bi";
BlocklyGamesMsg["Turtle.widthTooltip"] = "Chynges the width o the pen.";
BlocklyGamesMsg["Turtle.setWidth"] = "set width tae";
BlocklyGamesMsg["Turtle.colourTooltip"] = "Chynges the colour o the pen.";
BlocklyGamesMsg["Turtle.setColour"] = "set colour tae";
BlocklyGamesMsg["Turtle.penTooltip"] = "Lifts or lowers the pen, tae stap or stairt drawin.";
BlocklyGamesMsg["Turtle.penUp"] = "pen up";
BlocklyGamesMsg["Turtle.penDown"] = "pen doon";
BlocklyGamesMsg["Turtle.turtleVisibilityTooltip"] = "Maks the turtle (circle n pointer) veesible or onveesible.";
BlocklyGamesMsg["Turtle.hideTurtle"] = "skauk turtle";
BlocklyGamesMsg["Turtle.showTurtle"] = "shaw turtle";
BlocklyGamesMsg["Turtle.printHelpUrl"] = "https://en.wikipedia.org/wiki/Printing";  // untranslated
BlocklyGamesMsg["Turtle.printTooltip"] = "Draws tex in the turtle's direction at its location.";
BlocklyGamesMsg["Turtle.print"] = "prent";
BlocklyGamesMsg["Turtle.fontHelpUrl"] = "https://en.wikipedia.org/wiki/Font";  // untranslated
BlocklyGamesMsg["Turtle.fontTooltip"] = "Sets the font uised bi the prent block.";
BlocklyGamesMsg["Turtle.font"] = "font";
BlocklyGamesMsg["Turtle.fontSize"] = "font size";
BlocklyGamesMsg["Turtle.fontNormal"] = "normal";
BlocklyGamesMsg["Turtle.fontBold"] = "baud";
BlocklyGamesMsg["Turtle.fontItalic"] = "italeec";
