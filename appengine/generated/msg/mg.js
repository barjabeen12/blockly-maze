...
BlocklyMsg["VARIABLES_DEFAULT_NAME"] = "Zavatra";
BlocklyMsg["UNNAMED_KEY"] = "unnamed";  // untranslated
BlocklyMsg["TODAY"] = "Androany";
BlocklyMsg["DUPLICATE_BLOCK"] = "Tahahana";
BlocklyMsg["ADD_COMMENT"] = "Hanampy resaka";
BlocklyMsg["REMOVE_COMMENT"] = "Hanala resaka";
BlocklyMsg["DUPLICATE_COMMENT"] = "Duplicate Comment";  // untranslated
BlocklyMsg["EXTERNAL_INPUTS"] = "Iditra ivelany";
BlocklyMsg["INLINE_INPUTS"] = "Iditra an'andalana";
BlocklyMsg["DELETE_BLOCK"] = "Hamafa bilaoky";
BlocklyMsg["DELETE_X_BLOCKS"] = "Hamafa bilaoky %1";
BlocklyMsg["DELETE_ALL_BLOCKS"] = "Hamafa ny bilaoky %1 rehetra ?";
BlocklyMsg["CLEAN_UP"] = "Hanadio bilaoky";
...
BlocklyMsg["EXPAND_ALL"] = "Hanitatra bilaoky";
BlocklyMsg["DISABLE_BLOCK"] = "Hanajanona ny bilaoky";
BlocklyMsg["ENABLE_BLOCK"] = "Handefa ny bilaoky";
BlocklyMsg["HELP"] = "Fanoroana";
BlocklyMsg["UNDO"] = "Esorina";
BlocklyMsg["REDO"] = "Averina atao";
BlocklyMsg["CHANGE_VALUE_TITLE"] = "Hanova sanda:";
BlocklyMsg["RENAME_VARIABLE"] = "Hanova anarana ny ova...";
...
BlocklyMsg["COLOUR_RANDOM_TITLE"] = "loko kisendra";
...
BlocklyMsg["COLOUR_RGB_RED"] = "mena";
BlocklyMsg["COLOUR_RGB_GREEN"] = "maitso";
BlocklyMsg["COLOUR_RGB_BLUE"] = "manga";
...
BlocklyMsg["COLOUR_BLEND_TITLE"] = "afangaro";
BlocklyMsg["COLOUR_BLEND_COLOUR1"] = "loko 1";
BlocklyMsg["COLOUR_BLEND_COLOUR2"] = "loko 2";
BlocklyMsg["COLOUR_BLEND_RATIO"] = "taha";
...
BlocklyMsg["CONTROLS_REPEAT_INPUT_DO"] = "atao";
...
BlocklyMsg["CONTROLS_IF_MSG_IF"] = "raha";
BlocklyMsg["CONTROLS_IF_MSG_ELSEIF"] = "raha tsy izany";
BlocklyMsg["CONTROLS_IF_MSG_ELSE"] = "raha tsy izany raha";
...
BlocklyMsg["LOGIC_BOOLEAN_TRUE"] = "marina";
BlocklyMsg["LOGIC_BOOLEAN_FALSE"] = "diso";
...
BlocklyMsg["LOGIC_NULL"] = "foana";
BlocklyMsg["LOGIC_NULL_TOOLTIP"] = "Mamerina sanda foana";
BlocklyMsg["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
BlocklyMsg["LOGIC_TERNARY_CONDITION"] = "andrana";
BlocklyMsg["LOGIC_TERNARY_IF_TRUE"] = "raha marina";
BlocklyMsg["LOGIC_TERNARY_IF_FALSE"] = "raha diso";
...
BlocklyMsg["MATH_NUMBER_TOOLTIP"] = "Laharana.";
...
BlocklyMsg["MATH_ROUND_OPERATOR_ROUND"] = "boriboriana";
BlocklyMsg["MATH_ROUND_OPERATOR_ROUNDUP"] = "boriboriana amin'ny sanda ambony";
BlocklyMsg["MATH_ROUND_OPERATOR_ROUNDDOWN"] = "boriboriana amin'ny sanda ambany";
BlocklyMsg["MATH_ONLIST_HELPURL"] = "";  // untranslated
BlocklyMsg["MATH_ONLIST_OPERATOR_SUM"] = "tambatry ny lisitra";
BlocklyMsg["MATH_ONLIST_TOOLTIP_SUM"] = "Return the sum of all the numbers in the list.";  // untranslated
BlocklyMsg["MATH_ONLIST_OPERATOR_MIN"] = "kely indrindra amin'ny lisitra";
BlocklyMsg["MATH_ONLIST_TOOLTIP_MIN"] = "Return the smallest number in the list.";  // untranslated
BlocklyMsg["MATH_ONLIST_OPERATOR_MAX"] = "lehibe indrindra amin'ny lisitra";
...
BlocklyMsg["DIALOG_CANCEL"] = "Aoka ihany";

BlocklyMsg["CONTROLS_WHILEUNTIL_INPUT_DO"] = "atao";
BlocklyMsg["CONTROLS_FOR_INPUT_DO"] = "atao";
BlocklyMsg["CONTROLS_FOREACH_INPUT_DO"] = "atao";
BlocklyMsg["CONTROLS_IF_MSG_THEN"] = "atao";
BlocklyMsg["CONTROLS_IF_IF_TITLE_IF"] = "raha";
BlocklyMsg["CONTROLS_IF_ELSEIF_TITLE_ELSEIF"] = "raha tsy izany";
BlocklyMsg["CONTROLS_IF_ELSE_TITLE_ELSE"] = "raha tsy izany raha";
BlocklyMsg["MATH_CHANGE_TITLE_ITEM"] = "Zavatra";
BlocklyMsg["TEXT_CREATE_JOIN_ITEM_TITLE_ITEM"] = "Zavatra";
BlocklyMsg["TEXT_APPEND_VARIABLE"] = "Zavatra";
BlocklyMsg["LISTS_CREATE_WITH_ITEM_TITLE"] = "Zavatra";
...
BlocklyGamesMsg["Games.puzzle"] = "Piozila";
BlocklyGamesMsg["Games.maze"] = "Labirainty";
...
BlocklyGamesMsg["Games.linkTooltip"] = "Hitahiry ary hampirohy amin'ny bolongana.";
BlocklyGamesMsg["Games.runTooltip"] = "Run the program you wrote.";  // untranslated
BlocklyGamesMsg["Games.runProgram"] = "Handefa ny fandaharana";
BlocklyGamesMsg["Games.resetTooltip"] = "Stop the program and reset the level.";  // untranslated
BlocklyGamesMsg["Games.resetProgram"] = "Averina";
BlocklyGamesMsg["Games.help"] = "Fanoroana";
BlocklyGamesMsg["Games.catLogic"] = "Lôjika";
BlocklyGamesMsg["Games.catLoops"] = "Tondro mifolaka";
BlocklyGamesMsg["Games.catMath"] = "Matematika";
BlocklyGamesMsg["Games.catText"] = "Soratra";
BlocklyGamesMsg["Games.catLists"] = "Lisitra";
BlocklyGamesMsg["Games.catColour"] = "Loko";
BlocklyGamesMsg["Games.catVariables"] = "Ova";
BlocklyGamesMsg["Games.catProcedures"] = "Paika";
BlocklyGamesMsg["Games.httpRequestError"] = "Nisy olana tamin'ilay hataka.";
BlocklyGamesMsg["Games.linkAlert"] = "Zarao amin'ity rohy ity ny bolonganao: \n\n%1";
BlocklyGamesMsg["Games.hashError"] = "Miala tsiny, tsy miady amin'ny fandaharana notehirizina '%1'.";
BlocklyGamesMsg["Games.xmlError"] = "Tsy nahasokatra ny rakitra voatahirinao. Mety namboarina tamin'ny versionan'i Blockly hafa angamba ilay izy?";
...
BlocklyGamesMsg["Games.listVariable"] = "lisitra";
BlocklyGamesMsg["Games.textVariable"] = "soratra";
...
BlocklyGamesMsg["Puzzle.legsChoose"] = "fidio...";
BlocklyGamesMsg["Puzzle.traits"] = "traits:";  // untranslated
BlocklyGamesMsg["Puzzle.error0"] = "Tena tsara! Marina daholo ny bolongana %1.";
BlocklyGamesMsg["Puzzle.error1"] = "Saika! Bolongana iray sisa no diso.";
BlocklyGamesMsg["Puzzle.error2"] = "Bolongana %1 no diso.";
BlocklyGamesMsg["Puzzle.tryAgain"] = "Diso ilay bolongana mangirangirana.\nAndramo fanindroany.";
BlocklyGamesMsg["Puzzle.checkAnswers"] = "Hanamarina ny valiny";
...
BlocklyGamesMsg["Maze.moveForward"] = "handroso";
BlocklyGamesMsg["Maze.turnLeft"] = "hihodina ankavia";
BlocklyGamesMsg["Maze.turnRight"] = "hihodina ankavanana";
BlocklyGamesMsg["Maze.doCode"] = "atao";
BlocklyGamesMsg["Maze.elseCode"] = "rahatsyizany";
BlocklyGamesMsg["Maze.helpIfElse"] = "Hanaoo zavatra iray na iray hafa ny bolongana Raha-rahatsyizany";
BlocklyGamesMsg["Maze.pathAhead"] = "raha lalana eo aloha";
BlocklyGamesMsg["Maze.pathLeft"] = "raha lalana miankavia";
BlocklyGamesMsg["Maze.pathRight"] = "raha lalana miankavanana";
BlocklyGamesMsg["Maze.repeatUntil"] = "avereno hatramy";
...
BlocklyGamesMsg["Maze.capacity0"] = "bolongana %0 sisa.";
BlocklyGamesMsg["Maze.capacity1"] = "Bolongana %1 sisa.";
BlocklyGamesMsg["Maze.capacity2"] = "Bolongana %1 sisa.";
...
BlocklyGamesMsg["Turtle.fontNormal"] = "tsotra";
BlocklyGamesMsg["Turtle.fontBold"] = "soramatevina";
BlocklyGamesMsg["Turtle.fontItalic"] = "italika";
