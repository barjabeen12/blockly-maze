...
BlocklyMsg["MATH_CHANGE_TITLE_ITEM"] = "變量";
BlocklyMsg["TEXT_CREATE_JOIN_ITEM_TITLE_ITEM"] = "變量";
BlocklyMsg["TEXT_APPEND_VARIABLE"] = "變量";
BlocklyMsg["LISTS_CREATE_WITH_ITEM_TITLE"] = "變量";
...
BlocklyGamesMsg["Games.puzzle"] = "迷局";
...
BlocklyGamesMsg["Games.xmlError"] = "沒存到你保存个檔案。可能它係從其他版本个Blockly創建麼？";
...
BlocklyGamesMsg["Puzzle.error0"] = "讚！\n%1 格仔全部正確。";
BlocklyGamesMsg["Puzzle.error1"] = "差滴！有 1 格毋著。";
BlocklyGamesMsg["Puzzle.error2"] = "%1 格毋著。";
BlocklyGamesMsg["Puzzle.tryAgain"] = "加光个格仔毋著。\n繼續努力。";
BlocklyGamesMsg["Puzzle.checkAnswers"] = "核對答案";
BlocklyGamesMsg["Puzzle.helpText"] = "每隻國家（青色），選擇其對應个旗幟，語言，與城市。";
BlocklyGamesMsg["Maze.moveForward"] = "move forward";  // untranslated
BlocklyGamesMsg["Maze.turnLeft"] = "左彎";
BlocklyGamesMsg["Maze.turnRight"] = "右彎";
BlocklyGamesMsg["Maze.doCode"] = "做";
BlocklyGamesMsg["Maze.elseCode"] = "不過";
BlocklyGamesMsg["Maze.helpIfElse"] = "If-else blocks will do one thing or the other.";  // untranslated
BlocklyGamesMsg["Maze.pathAhead"] = "佬前方有路";
BlocklyGamesMsg["Maze.pathLeft"] = "佬左邊有路";
BlocklyGamesMsg["Maze.pathRight"] = "佬右邊有路";
BlocklyGamesMsg["Maze.repeatUntil"] = "重覆直到";
BlocklyGamesMsg["Maze.moveForwardTooltip"] = "前行一步。";
BlocklyGamesMsg["Maze.turnTooltip"] = "向左還有向右彎90度。";
