...
BlocklyMsg["TODAY"] = "Бүгүн";
BlocklyMsg["DUPLICATE_BLOCK"] = "Дубликат";
BlocklyMsg["ADD_COMMENT"] = "Пикириңизди кошуңуз";
BlocklyMsg["REMOVE_COMMENT"] = "Жорумду өчүрүү";
BlocklyMsg["DUPLICATE_COMMENT"] = "Duplicate Comment";  // untranslated
BlocklyMsg["EXTERNAL_INPUTS"] = "Тышкы Толуктоолор";
BlocklyMsg["INLINE_INPUTS"] = "Ички Толуктоолор";
BlocklyMsg["DELETE_BLOCK"] = "Блокту Өчүрүү";
BlocklyMsg["DELETE_X_BLOCKS"] = "Блоктун 1%ын Өчүрүү";
BlocklyMsg["DELETE_ALL_BLOCKS"] = "1% блоктордун баарын өчүрүү, йа?";
BlocklyMsg["CLEAN_UP"] = "Блокторду тазалоо";
BlocklyMsg["COLLAPSE_BLOCK"] = "Блокту жашыруу";
BlocklyMsg["COLLAPSE_ALL"] = "Блокторду жашыруу";
BlocklyMsg["EXPAND_BLOCK"] = "Блокту кеңейтүү";
BlocklyMsg["EXPAND_ALL"] = "Блокторду кеңейтүү";
BlocklyMsg["DISABLE_BLOCK"] = "Блок жараксыз";
BlocklyMsg["ENABLE_BLOCK"] = "Блок жарактуу";
BlocklyMsg["HELP"] = "Жардам";
BlocklyMsg["UNDO"] = "Undo";  // untranslated
BlocklyMsg["REDO"] = "Redo";  // untranslated
BlocklyMsg["CHANGE_VALUE_TITLE"] = "маанисин өзгөрт";
BlocklyMsg["RENAME_VARIABLE"] = "Өзгөрмөнүн атын алмаштыруу";
BlocklyMsg["RENAME_VARIABLE_TITLE"] = "Баардык '%1' өзгөрмөнүнүн атын алмаштыр";
BlocklyMsg["NEW_VARIABLE"] = "жаңы өзгөрмө";
...
BlocklyMsg["NEW_VARIABLE_TITLE"] = "Жаңы өзгөрмөнүн аты";
...
BlocklyMsg["COLOUR_PICKER_TOOLTIP"] = "палитрадан түс танда";
BlocklyMsg["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
BlocklyMsg["COLOUR_RANDOM_TITLE"] = "тушкелди түс";
BlocklyMsg["COLOUR_RANDOM_TOOLTIP"] = "Түстү тушкелди тандоо.";
BlocklyMsg["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
BlocklyMsg["COLOUR_RGB_TITLE"] = "түсү менен";
BlocklyMsg["COLOUR_RGB_RED"] = "кызыл";
BlocklyMsg["COLOUR_RGB_GREEN"] = "жашыл";
BlocklyMsg["COLOUR_RGB_BLUE"] = "көк";
BlocklyMsg["COLOUR_RGB_TOOLTIP"] = "Кызыл, жашыл жана көк түстөрдөн жаңы түс жаса. Ар бир түстүн мааниси 0 менен 100 арасында болуусу керек.";
BlocklyMsg["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
BlocklyMsg["COLOUR_BLEND_TITLE"] = "аралаштыруу";
BlocklyMsg["COLOUR_BLEND_COLOUR1"] = "1-түс";
BlocklyMsg["COLOUR_BLEND_COLOUR2"] = "2-түс";
BlocklyMsg["COLOUR_BLEND_RATIO"] = "катышы";
BlocklyMsg["COLOUR_BLEND_TOOLTIP"] = "Эки түстү берилген катыш (0.0 - 1.0) менен аралаштыр.";
BlocklyMsg["CONTROLS_REPEAT_HELPURL"] = "https://en.wikipedia.org/wiki/For_loop";  // untranslated
BlocklyMsg["CONTROLS_REPEAT_TITLE"] = "%1 жолу кайтала";
BlocklyMsg["CONTROLS_REPEAT_INPUT_DO"] = "жаса";
BlocklyMsg["CONTROLS_REPEAT_TOOLTIP"] = "Билдирүүнү бир канча жолу кайтала";
BlocklyMsg["CONTROLS_WHILEUNTIL_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
BlocklyMsg["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "Кайтала эгерде";
BlocklyMsg["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "Кайтала чейин";
BlocklyMsg["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "Маани туура болгон учурда билдирүүлөрдү кайтала";
BlocklyMsg["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "Маани ката болгон учурда билдирүүлөрдү кайтала";
...
BlocklyMsg["CONTROLS_FOR_TITLE"] = "%1 менен %2 ден %3 кө чейин %4 төн эсепте";
BlocklyMsg["CONTROLS_FOREACH_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#for-each";  // untranslated
BlocklyMsg["CONTROLS_FOREACH_TITLE"] = "%2 катарынын ар бир элементи %1 үчүн";
...
BlocklyMsg["CONTROLS_IF_MSG_IF"] = "эгерде";
BlocklyMsg["CONTROLS_IF_MSG_ELSEIF"] = "же болбосо";
BlocklyMsg["CONTROLS_IF_MSG_ELSE"] = "башка";
...
BlocklyMsg["LOGIC_TERNARY_CONDITION"] = "текшерүү";
BlocklyMsg["LOGIC_TERNARY_IF_TRUE"] = "туура болсо";
BlocklyMsg["LOGIC_TERNARY_IF_FALSE"] = "ката болсо";
...
BlocklyMsg["MATH_TRIG_HELPURL"] = "https://ky.wikipedia.org/wiki/Тригонометриялык_функциялар";
...
BlocklyMsg["TEXT_ISEMPTY_TITLE"] = "%1 бош";
...
BlocklyMsg["DIALOG_CANCEL"] = "Cancel";  // untranslated

BlocklyMsg["CONTROLS_WHILEUNTIL_INPUT_DO"] = "жаса";
BlocklyMsg["CONTROLS_FOR_INPUT_DO"] = "жаса";
BlocklyMsg["CONTROLS_FOREACH_INPUT_DO"] = "жаса";
BlocklyMsg["CONTROLS_IF_MSG_THEN"] = "жаса";
BlocklyMsg["CONTROLS_IF_IF_TITLE_IF"] = "эгерде";
BlocklyMsg["CONTROLS_IF_ELSEIF_TITLE_ELSEIF"] = "же болбосо";
BlocklyMsg["CONTROLS_IF_ELSE_TITLE_ELSE"] = "башка";
...
BlocklyGamesMsg["Games.puzzle"] = "Баш катырма.";
...
BlocklyGamesMsg["Games.help"] = "Жардам";
BlocklyGamesMsg["Games.catLogic"] = "Logic";  // untranslated
BlocklyGamesMsg["Games.catLoops"] = "Loops";  // untranslated
BlocklyGamesMsg["Games.catMath"] = "Math";  // untranslated
BlocklyGamesMsg["Games.catText"] = "Text";  // untranslated
BlocklyGamesMsg["Games.catLists"] = "Lists";  // untranslated
BlocklyGamesMsg["Games.catColour"] = "Colour";  // untranslated
...
BlocklyGamesMsg["Games.listVariable"] = "list";  // untranslated
...
BlocklyGamesMsg["Puzzle.legsChoose"] = "тандаңыз...";
BlocklyGamesMsg["Puzzle.traits"] = "traits:";  // untranslated
BlocklyGamesMsg["Puzzle.error0"] = "Мыкты!\nБардык блоктор %1 туура жайгашкан.";
BlocklyGamesMsg["Puzzle.error1"] = "Аз калды!\nБир блок гана туура эмес жайгашкан.";
BlocklyGamesMsg["Puzzle.error2"] = "Бир нече блок (%1) туура эмес жайгашкан.";
BlocklyGamesMsg["Puzzle.tryAgain"] = "Белгиленген блок туура эмес жайгашкан.\nДагы аракет кылыңыз.";
BlocklyGamesMsg["Puzzle.checkAnswers"] = "Жоопторду текшерүү";
BlocklyGamesMsg["Puzzle.helpText"] = "Ар бир өлкөгө (жашыл), туусун кадаңыз, расмий тилин тандаңыз, жана ал өлкөнүн шаарларын белгилеңиз.";
