...
BlocklyMsg["HELP"] = "Help";  // untranslated
...
BlocklyMsg["DIALOG_OK"] = "Aceutar";
BlocklyMsg["DIALOG_CANCEL"] = "Encaboxar";
...
BlocklyGamesMsg["Games.puzzle"] = "Rompecabeces";
BlocklyGamesMsg["Games.maze"] = "Llaberintu";
BlocklyGamesMsg["Games.bird"] = "Páxaru";
...
BlocklyGamesMsg["Games.linesOfCode1"] = "Resolvisti esti nivel con 1 llinia de JavaScript:";
BlocklyGamesMsg["Games.linesOfCode2"] = "Resollvisti esti nivel con %1 llinies de JavaScript";
BlocklyGamesMsg["Games.nextLevel"] = "¿Tas llistu/a pal nivel %1?";
BlocklyGamesMsg["Games.finalLevel"] = "¿Tas llistu/a pal viniente nivel?";
BlocklyGamesMsg["Games.submitTitle"] = "Títulu:";
BlocklyGamesMsg["Games.linkTooltip"] = "Guardar y enllazar a los bloques.";
BlocklyGamesMsg["Games.runTooltip"] = "Executar el programa qu'escribisti.";
BlocklyGamesMsg["Games.runProgram"] = "Executar el programa";
BlocklyGamesMsg["Games.resetTooltip"] = "Detener el programa y restablecer el nivel.";
BlocklyGamesMsg["Games.resetProgram"] = "Reaniciar";
BlocklyGamesMsg["Games.help"] = "Ayuda";
BlocklyGamesMsg["Games.catLogic"] = "Lóxica";
BlocklyGamesMsg["Games.catLoops"] = "Bucles";
BlocklyGamesMsg["Games.catMath"] = "Matemátiques";
...
BlocklyGamesMsg["Games.httpRequestError"] = "Hubo un problema col pidimientu.";
BlocklyGamesMsg["Games.linkAlert"] = "Comparti los tos bloques con esti enllaz:\n\n%1";
BlocklyGamesMsg["Games.hashError"] = "Sentímoslo, '%1' nun correspuende con nengún programa guardáu.";
BlocklyGamesMsg["Games.xmlError"] = "Nun pudo cargase'l ficheru guardáu.\n¿Quiciabes foi creáu con otra versión de Blockly?";
BlocklyGamesMsg["Games.submitted"] = "¡Gracies por esti programa! Si gusta al nuesu grupu espertu de monos entrenaos, van espublizalu na galería nun par de díes.";
BlocklyGamesMsg["Games.listVariable"] = "Llista";
BlocklyGamesMsg["Games.textVariable"] = "Testu";
BlocklyGamesMsg["Games.breakLink"] = "En principiando la edición de JavaScript, nun vas poder volver a la edición de bloques. ¿Aceutes esto?";
BlocklyGamesMsg["Games.blocks"] = "Bloques";
BlocklyGamesMsg["Games.congratulations"] = "¡Norabona!";
BlocklyGamesMsg["Games.helpAbort"] = "Esti nivel ye desaxeradamente difícil. ¿Deseyes saltealu y dir al siguiente nivel? Siempres puedes tornar más palantre.";
BlocklyGamesMsg["Index.clear"] = "¿Borrar toles tos soluciones?";
BlocklyGamesMsg["Index.subTitle"] = "Xuegos pa los programadores del futuru.";
BlocklyGamesMsg["Index.moreInfo"] = "Información pa educadores...";
BlocklyGamesMsg["Index.startOver"] = "¿Quies entamar de nueves?";
BlocklyGamesMsg["Index.clearData"] = "Borrar datos";
BlocklyGamesMsg["Puzzle.animal1"] = "Coríu";
BlocklyGamesMsg["Puzzle.animal1Trait1"] = "Plumes";
BlocklyGamesMsg["Puzzle.animal1Trait2"] = "Picu";
BlocklyGamesMsg["Puzzle.animal1HelpUrl"] = "https://ast.wikipedia.org/wiki/Cor%C3%ADu";
...
BlocklyGamesMsg["Puzzle.animal2HelpUrl"] = "https://ast.wikipedia.org/wiki/Gatu";
BlocklyGamesMsg["Puzzle.animal3"] = "Abeya";
BlocklyGamesMsg["Puzzle.animal3Trait1"] = "Miel";
BlocklyGamesMsg["Puzzle.animal3Trait2"] = "Aguiyón";
BlocklyGamesMsg["Puzzle.animal3HelpUrl"] = "https://ast.wikipedia.org/wiki/Abeya";
BlocklyGamesMsg["Puzzle.animal4"] = "Cascoxu";
BlocklyGamesMsg["Puzzle.animal4Trait1"] = "Cascu";
BlocklyGamesMsg["Puzzle.animal4Trait2"] = "Baba";
BlocklyGamesMsg["Puzzle.animal4HelpUrl"] = "https://en.wikipedia.org/wiki/Snail";
BlocklyGamesMsg["Puzzle.picture"] = "semeya:";
BlocklyGamesMsg["Puzzle.legs"] = "pates:";
BlocklyGamesMsg["Puzzle.legsChoose"] = "escueye...";
BlocklyGamesMsg["Puzzle.traits"] = "traces:";
BlocklyGamesMsg["Puzzle.error0"] = "¡Perfeutu!\nLos %1 bloques tán bien asitiaos.";
BlocklyGamesMsg["Puzzle.error1"] = "¡Casi! Un bloque ta mal asitiáu.";
BlocklyGamesMsg["Puzzle.error2"] = "%1 bloques tán mal asitiaos.";
BlocklyGamesMsg["Puzzle.tryAgain"] = "El bloque destacáu ta mal asitiáu.\nSigui tentando.";
BlocklyGamesMsg["Puzzle.checkAnswers"] = "Comprobar les respuestes";
BlocklyGamesMsg["Puzzle.helpText"] = "Pa cada animal (verde), axunta la so semeya, escueye la cantidá de pates y llista les sos traces.";
BlocklyGamesMsg["Maze.moveForward"] = "avanzar";
BlocklyGamesMsg["Maze.turnLeft"] = "xirar a la esquierda";
BlocklyGamesMsg["Maze.turnRight"] = "xirar a la drecha";
BlocklyGamesMsg["Maze.doCode"] = "faer";
BlocklyGamesMsg["Maze.elseCode"] = "sinón";
BlocklyGamesMsg["Maze.helpIfElse"] = "Los bloques 'si-sinón' faen una cosa o la otra";
BlocklyGamesMsg["Maze.pathAhead"] = "si hai camín enfrente";
BlocklyGamesMsg["Maze.pathLeft"] = "si hai camín a la esquierda";
BlocklyGamesMsg["Maze.pathRight"] = "si hai camín a la drecha";
BlocklyGamesMsg["Maze.repeatUntil"] = "repitir fasta";
BlocklyGamesMsg["Maze.moveForwardTooltip"] = "Muevi al xugador un cuadru p'alantre.";
BlocklyGamesMsg["Maze.turnTooltip"] = "Xira al xugador a esquierda o drecha 90 graos.";
BlocklyGamesMsg["Maze.ifTooltip"] = "Si hai un camín na direición especificada, entós executa unes aiciones.";
BlocklyGamesMsg["Maze.ifelseTooltip"] = "Si hai un camín na direición especificada, entós executa'l primer bloque d'aiciones. Sinón, executa'l segundu bloque d'aiciones.";
BlocklyGamesMsg["Maze.whileTooltip"] = "Repiti les aiciones conteníes fasta algamar el puntu final.";
BlocklyGamesMsg["Maze.capacity0"] = "Quédente %0 bloques.";
BlocklyGamesMsg["Maze.capacity1"] = "Quédate %1 bloque.";
BlocklyGamesMsg["Maze.capacity2"] = "Quédente %2 bloques.";
BlocklyGamesMsg["Maze.runTooltip"] = "Fai que'l xugador faiga lo que dicen los bloques.";
BlocklyGamesMsg["Maze.resetTooltip"] = "Llevar al xugador al empiezu'l llaberintu.";
BlocklyGamesMsg["Maze.helpStack"] = "Xune un par de bloques 'avanzar' p'ayudame algamar la meta.";
BlocklyGamesMsg["Maze.helpOneTopBlock"] = "Nesti nivel precises xunir todos los bloques nel espaciu de trabay blancu.";
BlocklyGamesMsg["Maze.helpRun"] = "Executa'l to programa pa ver qué pasa.";
BlocklyGamesMsg["Maze.helpReset"] = "El to programa nun resolvió'l llaberintu. Prima 'Reaniciar' y tenta otra vegada.";
BlocklyGamesMsg["Maze.helpRepeat"] = "Algama'l final d'esti camín usando sólo dos bloques. Usa 'repitir' pa executar un bloque mas d'una vegada.";
BlocklyGamesMsg["Maze.helpCapacity"] = "Usasti tolos bloques pa esti nivel. Pa crear un bloque nuevu tienes de desaniciar un bloque esistente.";
BlocklyGamesMsg["Maze.helpRepeatMany"] = "Pues usar más d'un bloque dientro d'un bloque 'repetir'.";
BlocklyGamesMsg["Maze.helpSkins"] = "Escueye'l to xugador favoritu dende esti menú.";
BlocklyGamesMsg["Maze.helpIf"] = "Un bloque 'si' va faer daqué sólo si la condición ye verdadera. Tenta xirar a la izquierda si hai camín a la izquierda.";
BlocklyGamesMsg["Maze.helpMenu"] = "Pulsia %1 nel bloque «si» pa camudar la so condición.";
BlocklyGamesMsg["Maze.helpWallFollow"] = "¿Pues resolver esti complicáu llaberintu? Tenta siguir la paré de la izquierda. ¡Sólo pa programadores avanzaos!";
BlocklyGamesMsg["Bird.noWorm"] = "nun tien guxanu";
BlocklyGamesMsg["Bird.heading"] = "Cabecera";
BlocklyGamesMsg["Bird.noWormTooltip"] = "La condición cuandu'l páxari nun consiguió'l vierme.";
BlocklyGamesMsg["Bird.headingTooltip"] = "Mover na dirección del ángulu especificáu: 0 ye a la derecha, 90 ye de frente, etc.";
BlocklyGamesMsg["Bird.positionTooltip"] = "x y y marquen la posición del páxaru. Cuando x = 0 el páxaru ta pegando al cantu izquierdu, cuando x = 100 ta pegando al derechu. Cuando y = 0 el páxaru ta na parte inferior, cuando y = 100 ta na parte cimera.";
BlocklyGamesMsg["Bird.helpHeading"] = "Cambia l'ángulu de direición pa facer que'l páxaru consiga'l guxanu y aterrice nel so nial.";
BlocklyGamesMsg["Bird.helpHasWorm"] = "Usa esti bloque para siguir una direición si tienes el guxanu, o otra direición si nun lu tienes.";
...
BlocklyGamesMsg["Movie.x1"] = "entamu x";
BlocklyGamesMsg["Movie.y1"] = "entamu y";
BlocklyGamesMsg["Movie.x2"] = "final x";
BlocklyGamesMsg["Movie.y2"] = "final y";
BlocklyGamesMsg["Movie.radius"] = "radiu";
BlocklyGamesMsg["Movie.width"] = "anchor";
BlocklyGamesMsg["Movie.height"] = "altor";
BlocklyGamesMsg["Movie.circleTooltip"] = "Draws a circle at the specified location and with the specified radius.";  // untranslated
BlocklyGamesMsg["Movie.circleDraw"] = "círculu";
...
BlocklyGamesMsg["Movie.setColour"] = "Establecer color a";
...
BlocklyGamesMsg["Pond.playerName"] = "Xugador";
BlocklyGamesMsg["Pond.targetName"] = "Oxetivu";
BlocklyGamesMsg["Pond.pendulumName"] = "Pendilexu";
BlocklyGamesMsg["Pond.scaredName"] = "Asustáu";
