...
BlocklyMsg["VARIABLES_DEFAULT_NAME"] = "ഇനം";
BlocklyMsg["UNNAMED_KEY"] = "പേരില്ലാത്തവ";
BlocklyMsg["TODAY"] = "ഇന്ന്";
BlocklyMsg["DUPLICATE_BLOCK"] = "പകർപ്പ്";
BlocklyMsg["ADD_COMMENT"] = "അഭിപ്രായം ചേർക്കുക";
BlocklyMsg["REMOVE_COMMENT"] = "അഭിപ്രായം ഒഴിവാക്കുക";
...
BlocklyMsg["HELP"] = "സഹായം";
BlocklyMsg["UNDO"] = "തിരസ്കരിക്കുക";
BlocklyMsg["REDO"] = "വീണ്ടും ചെയ്യുക";
BlocklyMsg["CHANGE_VALUE_TITLE"] = "Change value:";  // untranslated
BlocklyMsg["RENAME_VARIABLE"] = "ചരത്തിന്റെ പേര് മാറ്റുക...";
BlocklyMsg["RENAME_VARIABLE_TITLE"] = "Rename all '%1' variables to:";  // untranslated
BlocklyMsg["NEW_VARIABLE"] = "ചരം സൃഷ്ടിക്കുക...";
BlocklyMsg["NEW_STRING_VARIABLE"] = "സ്ട്രിങ് ചരം സൃഷ്ടിക്കുക...";
BlocklyMsg["NEW_NUMBER_VARIABLE"] = "ക്രമസംഖ്യ ചരം സൃഷ്ടിക്കുക...";
BlocklyMsg["NEW_COLOUR_VARIABLE"] = "നിറം ചരം സൃഷ്ടിക്കുക...";
BlocklyMsg["NEW_VARIABLE_TYPE_TITLE"] = "New variable type:";  // untranslated
BlocklyMsg["NEW_VARIABLE_TITLE"] = "പുതിയ ചരത്തിന്റെ പേര്:";
BlocklyMsg["VARIABLE_ALREADY_EXISTS"] = "\"%1\" എന്ന പേരിലുള്ള ചരം നിലവിലുണ്ട്.";
...
BlocklyMsg["COLOUR_RANDOM_TITLE"] = "ക്രമരഹിത നിറം";
BlocklyMsg["COLOUR_RANDOM_TOOLTIP"] = "ക്രമരഹിതമായി ഒരു നിറം തിരഞ്ഞെടുക്കുക.";
...
BlocklyMsg["COLOUR_RGB_RED"] = "ചുവപ്പ്";
BlocklyMsg["COLOUR_RGB_GREEN"] = "പച്ച";
BlocklyMsg["COLOUR_RGB_BLUE"] = "നീല";
...
BlocklyMsg["COLOUR_BLEND_COLOUR1"] = "ഒന്നാം നിറം";
BlocklyMsg["COLOUR_BLEND_COLOUR2"] = "രണ്ടാം നിറം";
BlocklyMsg["COLOUR_BLEND_RATIO"] = "അനുപാതം";
...
BlocklyMsg["CONTROLS_REPEAT_TITLE"] = "%1 തവണ ആവർത്തിക്കുക";
BlocklyMsg["CONTROLS_REPEAT_INPUT_DO"] = "do";  // untranslated
BlocklyMsg["CONTROLS_REPEAT_TOOLTIP"] = "ചില വരികൾ കൂടുതൽ തവണ ചെയ്യുക.";
...
BlocklyMsg["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "കുരുക്കിന് പുറത്തുകടക്കുക";
...
BlocklyMsg["MATH_CHANGE_TITLE_ITEM"] = "ഇനം";
BlocklyMsg["TEXT_CREATE_JOIN_ITEM_TITLE_ITEM"] = "ഇനം";
BlocklyMsg["TEXT_APPEND_VARIABLE"] = "ഇനം";
BlocklyMsg["LISTS_CREATE_WITH_ITEM_TITLE"] = "ഇനം";
...
BlocklyGamesMsg["Games.puzzle"] = "പ്രഹേളിക";
...
BlocklyGamesMsg["Games.help"] = "സഹായം";
...
BlocklyGamesMsg["Puzzle.legsChoose"] = "തിരഞ്ഞെടുക്കുക:";
BlocklyGamesMsg["Puzzle.traits"] = "traits:";  // untranslated
BlocklyGamesMsg["Puzzle.error0"] = "കൊള്ളാം!\nഎല്ലാ %1 തടയലുകളും ശരിയാണ്.";
BlocklyGamesMsg["Puzzle.error1"] = "കുഴപ്പമില്ല! ഒരു തടയൽ ശരിയല്ല.";
BlocklyGamesMsg["Puzzle.error2"] = "%1 തടയലുകൾ ശരിയല്ല.";
BlocklyGamesMsg["Puzzle.tryAgain"] = "പ്രമുഖമാക്കി കാണിക്കുന്ന തടയൽ ശരിയല്ല.\nവീണ്ടും ശ്രമിക്കുക.";
BlocklyGamesMsg["Puzzle.checkAnswers"] = "ഉത്തരങ്ങൾ പരിശോധിക്കുക";
BlocklyGamesMsg["Puzzle.helpText"] = "ഓരോ രാജ്യത്തിനും (പച്ച), അതിന്റെ പതാക ചേർക്കുക, ഭാഷ തിരഞ്ഞെടുക്കുക ഒപ്പം നഗരങ്ങളുടെ പട്ടിക തയ്യാറാക്കുക.";
